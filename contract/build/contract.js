...
let DonationContract = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = call({
  ...
  payableFunction: true
}), _dec6 = view(), _dec(_class = (_class2 = class DonationContract {
  beneficiary = "v1.faucet.nonofficial.testnet";
  records = new UnorderedMap("records");
  diaryInfo = new UnorderedMap("diary");
  init({
    beneficiary
  }) {
  ...
  addRecode({
    ...
    const innerMap = this.records.get(user, {
      ...
      defaultValue: new UnorderedMap("record")
    });
    innerMap.set(String(timeStamp), {
      weather: weather,
      emotion: emotion,
      emotionDetail: emotionDetail,
      simpleDairy: simpleDairy,
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "addRecode", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "addRecode"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getRecode", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "getRecode"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "setDiary", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "setDiary"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getDiary", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "getDiary"), _class2.prototype)), _class2)) || _class);
function getDiary() {
  ...
  const _result = _contract.getDiary(_args);
...
function setDiary() {
  ...
  const _args = DonationContract._getArgs();
  const _result = _contract.setDiary(_args);
...
function getRecode() {
  ...
  const _args = DonationContract._getArgs();
  const _result = _contract.getRecode(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DonationContract._serialize(_result, true));
}
function addRecode() {
  const _state = DonationContract._getState();
  ...
  const _args = DonationContract._getArgs();
  const _result = _contract.addRecode(_args);
  DonationContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DonationContract._serialize(_result, true));
}
function init() {
...
export { addRecode, getDiary, getRecode, init, setDiary };
